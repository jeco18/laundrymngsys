...
<body id="page-top">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row mb-3">
                        <div class="col-lg-4">
                            <div class="card mb-3">
                                <div class="card-body text-center shadow"><img class="rounded-circle mb-3 mt-4" src="assets/img/profile.png" width="110" height="110">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="functions/add-price.php" method="post">
                        ...
                        <input class="form-control" type="number" name="max_kilo" placeholder="Max Kilo" style="margin-bottom: 15px;" required="">
    ...
    <script>
        ...
        $('a[data-bs-target="#update"]').on('click', function() {
                ...
                var max_kilo = $(this).data('max_kilo');
                var price = $(this).data('price');
                console.log(id, name);
                $('input[name="data_id"]').val(id);
                $('input[name="type"]').val(name);
                $('input[name="max_kilo"]').val(max_kilo);
